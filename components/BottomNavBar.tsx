...
const MakeupIcon = ({ isActive }: { isActive: boolean }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={isActive ? 2.5 : 2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M10 21h4a2 2 0 002-2V7a2 2 0 00-2-2h-4a2 2 0 00-2 2v12a2 2 0 002 2z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M10 7V5c0-1.1.9-2 2-2h0a2 2 0 012 2v2" />
    </svg>
);
...
const BottomNavBar: React.FC<BottomNavBarProps> = ({ onNavigate, currentView }) => {
    ...
    const navItems = [
        ...
        { view: 'makeup', label: 'Maquillaje', icon: MakeupIcon },
